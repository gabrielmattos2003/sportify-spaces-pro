  ...
  return (
    <div className="md:hidden">
      <Sheet open={open} onOpenChange={setOpen}>
        ...
        <SheetContent side="right" className="w-[250px] sm:w-[300px] bg-black text-white [&>button]:border-secondary [&>button]:text-secondary [&>button:hover]:bg-secondary/10 [&>button]:focus-visible:ring-secondary">
